...
class PromptLoader:
    """Utility class to load the prompt template"""
    ...
    def load_prompt_template() -> str:
        ...
        try:
            ...
            return """Actúa como Analista Funcional Senior + BA + Diseñador UX de producto bancario, experto en BPM/Workflow y en documentación de HUs implementables y testeables.
